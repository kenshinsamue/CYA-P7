...
// funcion para leer los estados del fichero .dfa e insertarlos dentro del automata
...
// funcion para leer las cadenas pertenecientes al alfabeto del automata del fichero
...
// funcion que lee los identificadores de los estados para saber si son o no de aceptacion
